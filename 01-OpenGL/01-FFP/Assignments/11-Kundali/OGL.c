...
void display(void) 
{
    ...
    void drawQuadOutline(float, float, float, float, float, float, float, float);

    // variable declarations 
    float outerSquareCornerX, outerSquareCornerY; 

    // code 
    glClear(GL_COLOR_BUFFER_BIT); 

    outerSquareCornerX = 0.6f; 
    outerSquareCornerY = 0.6f; 

    glLineWidth(2.0f); 
    glColor3f(1.0f, 0.5f, 0.25f); 
    drawQuadOutline(
        outerSquareCornerX, outerSquareCornerY, 
        -outerSquareCornerX, outerSquareCornerY, 
        -outerSquareCornerX, -outerSquareCornerY, 
        outerSquareCornerX, -outerSquareCornerY 
    ); 
    drawQuadOutline(
        0.0f, outerSquareCornerY, 
        -outerSquareCornerX, 0.0f, 
        0.0f, -outerSquareCornerY,
        outerSquareCornerX, 0.0f  
    ); 

    glBegin(GL_LINES); 
    glVertex3f(outerSquareCornerX, outerSquareCornerY, 0.0f); 
    glVertex3f(-outerSquareCornerX, -outerSquareCornerY, 0.0f); 
    ...
    ) 
{
    ...
    glVertex3f(topRightX, topRightY, 0.0f); 
    glVertex3f(topLeftX, topLeftY, 0.0f); 
    glVertex3f(bottomLeftX, bottomLeftY, 0.0f); 
