...
void display(void)
{
	...
	cubeX = 12.0f * cos(revolveAngleCube * M_PI/180.0f); 
	cubeZ = 12.0f * sin(revolveAngleCube * M_PI/180.0f); 
...
{
	// code
	revolveAngleCube = revolveAngleCube + 0.02f; 
	if(revolveAngleCube >= 360.0f) 
		revolveAngleCube = 0.0f; 
}
