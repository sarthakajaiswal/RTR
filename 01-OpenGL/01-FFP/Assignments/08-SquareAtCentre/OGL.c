...
void display(void) 
{
    ...
    float graphLineNumberForVertexOfSquare = 15;   // value should be smaller than numberOfBlueLines 
                                                    // greater the value larger the square
    float vertexCoordinateOfSquare; 
    ...
    // draw square  
    vertexCoordinateOfSquare = graphLineNumberForVertexOfSquare * distanceBetweenTwoLines; 
    
    glColor3f(1.0f, 1.0f, 0.0f); 
    glBegin(GL_LINE_LOOP); 
    glVertex3f(vertexCoordinateOfSquare, vertexCoordinateOfSquare, 0.0f); 
    glVertex3f(-vertexCoordinateOfSquare, vertexCoordinateOfSquare, 0.0f); 
    glVertex3f(-vertexCoordinateOfSquare, -vertexCoordinateOfSquare, 0.0f); 
    glVertex3f(vertexCoordinateOfSquare, -vertexCoordinateOfSquare, 0.0f);  
    glEnd(); 
