...
#define _USE_MATH_DEFINES 1 
							/* 
								math.h says define this to 1, to use my macros 
								it is already for some OS, but for mac it isn't 
							*/
#include <math.h> 
...
void display(void)
{
	...
	/*
		...
		Here, identity matrix, scale matrix and translation matrix are not changing here over the loop. 
		So we can initialize them once, in initialize(). 
		
		and rotate matrix should be defined here as it is changing every loop. 
	*/
	...
	glMultMatrixf(translationMatrix); 	/* multiplies CTM with input matrix */
