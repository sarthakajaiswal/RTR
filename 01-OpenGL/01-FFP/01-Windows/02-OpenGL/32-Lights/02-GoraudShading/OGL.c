...
int initialize(void)
{
	...
	glMaterialfv(GL_FRONT, GL_AMBIENT, materialAmbient); // jr sphere rotating aste tr GL_FRONT_ANF_BACK lihil ast 
														// pn ithe back distach nahi aahe tr ugich load n wadhwta fakt GL_FRONT waprla aahe 	 
...
void display(void)
{
	...
	// normal nahi ghetle kaaran te gluSphere chya aata ghetle aahet
	gluSphere(quadric, 0.6f, 50, 50); 
