...
void display(void)
{
	...
	glRotatef(anlgeTriangle, 0.0f, 1.0f, 0.0f); 
...
{
	// code
	anlgeTriangle = anlgeTriangle + 2.0f;

	if (anlgeTriangle >= 360.0f)
	{
		anlgeTriangle = anlgeTriangle - 360.0f;
	}
}
